...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002579163919"))
...
API_KEY = getenv("API_KEY", None) # youtube song api key, get it from https://t.me/god_hyper_o_p
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://iili.io/3V9CdLG.md.jpg",
)

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://iili.io/3V9BQqv.md.jpg",
)

PLAYLIST_IMG_URL = getenv(
    "PLAYLIST_IMG_URL",
    "https://iili.io/3V9BXe9.md.jpg",
)
